...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = zeroyt7.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© OCHOBOTZ ","listType": "SINGLE_SELECT","sections": list}}, {})
	...
	key : {
       ...
       message: {
       	         orderMessage: {
       	                  ...
       	                  status: 1,
                             surface : 1,
       	                  message: `OCHOBOTZ Selfbot!`,
                             orderTitle: `OCHOBOTZ Selfbot!`,
                             sellerJid: '0@s.whatsapp.net' 
                           }
                         }
                       }
...
switch (command) {
	...
	case 'help':
teks = `*Hallo ${pushname}*
Harap Gunakan *${botname}* BoT Dengan Baik Ya 🤗
...
Script Asli By OCHO & RIDHO JB 
Tidak ada button? Bisa ketik *${prefix}allmenu*`
img = fs.readFileSync('./zeroyt7/zero.jpg')
trans = `© OCHOBOTZ`
but = [{ buttonId: `${prefix}command`, buttonText: { displayText: 'LIST MENU' }, type: 1 },{ buttonId: `${prefix}listsewa`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },{ buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER BOT' }, type: 1 },]
        sendButImage(from, teks, trans, img, but)
break
        case 'command':
               list = []
               listmenu = [`groupmenu`,`scriptMenu`,`searchmenu`,`stickermenu`,`islamimenu`,`ownermenu`,`bugmenu`,`tebakmenu`,`downloadmenu`,`infomenu`,`textmenu`,`imagemenu`,`stalkmenu`]
               listmenuu = [`Menu Group`,`GAME MENU`,`Search Menu`,`Sticker Menu`,`Islami Menu`,`Owner Menu`,`Bug Menu`,`Tebak Menu`,`Download Menu`,`Info Menu`,`Text Menu`,`Image Menu`,`Stalk Menu`]
               nombor = 1
               startnum = 0
...
if (!isBotGroupAdmins) return reply("*Bot Bukan Admin :)*")
but = [
{ buttonId: '!grupbuka', buttonText: { displayText: 'Buka' }, type: 1 },
{ buttonId: '!gruptutup', buttonText: { displayText: 'Tutup' }, type: 1 }
]
...
//------------------< Menunya Bang:v >-------------------
      case 'grupbot':
             reply('*Mau test bot?* Disini aja!\n*Join Kak :* https://chat.whatsapp.com/HZNIXyJoDK86SEfItnuIn4')
             break
      case 'bot':
      case 'info':
      case 'infobot':
teks = `*Hallo!* ${pushname}
Perlu bantuan dari *OCHOBOTZ*?
 ...
 *DANA*💸
 *OVO*💸
*NOTE!* : InFo Lebih Lanjut Hub Owner. `
        img = fs.readFileSync('./zeroyt7/zero.jpg')
trans = `© OCHOBOTZ`
but = [{ buttonId: `${prefix}help`, buttonText: { displayText: 'KEMBALI' }, type: 1 },{ buttonId: `${prefix}payment`, buttonText: { displayText: 'PAYMENT' }, type: 1 }]
        sendButImage(from, menunya, trans, img, but)
break
case 'ml':
case 'mobile legends':
menunya = `🔥 _*MOBILE LEGENDS VIA ID*_
86    💎 Rp 20.000 
172  💎  Rp39.900 
257  💎 Rp59.850 
343  💎  Rp79.800 
...
Nb : Silahkan,anda bisa custom sendiri sesuai pesanan

*PAYMENT :* 💵
*GOPAY*💸
*DANA*💸
*OVO*💸
*NOTE!* : Ini Hanya Percobaan Jadi OCHOBOTZ Tidak Jualan Diamond.`
        img = fs.readFileSync('./zeroyt7/zero.jpg')
trans = `© OCHOBOTZ`
but = [{ buttonId: `${prefix}help`, buttonText: { displayText: 'KEMBALI' }, type: 1 },{ buttonId: `${prefix}payment`, buttonText: { displayText: 'PAYMENT' }, type: 1 }]
        sendButImage(from, menunya, trans, img, but)
...
*DANA*💸
*OVO*💸
*NOTE!* : Silahkan,anda bisa custom sendiri sesuai pesanan.`
        img = fs.readFileSync('./zeroyt7/zero.jpg')
trans = `© OCHOBOTZ`
but = [{ buttonId: `${prefix}help`, buttonText: { displayText: 'KEMBALI' }, type: 1 },{ buttonId: `${prefix}payment`, buttonText: { displayText: 'PAYMENT' }, type: 1 }]
        sendButImage(from, menunya, trans, img, but)
...
case 'payment':
teks =`
*Top up Game Di OCHO JB, Payment :*
*1. ${prefix} Gopay*
*2. ${prefix} Ovo*
*3. ${prefix} Dana*`
img = fs.readFileSync('./zeroyt7/zero.jpg')
trans = `© OCHOBOTZ`
but = [{ buttonId: `${prefix}help`, buttonText: { displayText: 'KEMBALI' }, type: 1 }]
        sendButImage(from, teks, trans, img, but)
        break
case 'gopay':
teks =`
1. Gunakan Qr Code Di Atas Untuk Scan 
2. Buka Apk Gopay
3. Isi Nominal/Jumlah 
4. Tranfer
5. Screenshot & Tunjukan ke Owner BoT `
img = fs.readFileSync('./zeroyt7/zero26.jpg')
trans = `© OCHOBOTZ`
but = [{ buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER BOT' }, type: 1 },]
        sendButImage(from, teks, trans, img, but)
        break
case 'ovo':
teks =`
...
zeroyt7.sendMessage(`6281215567282@s.whatsapp.net`, options, text, { quoted: ftrol })
...
Ketik ${prefix}owner Untuk mulai chat, *Utamakan Salam!*`
    img = fs.readFileSync('./zeroyt7/zero26.jpg')
trans = `© OCHOBOTZ`
but = [{ buttonId: `${prefix}payment`, buttonText: { displayText: 'PAYMENT' }, type: 1 },{ buttonId: `${prefix}help`, buttonText: { displayText: 'KEMBALI' }, type: 1 }]
        sendButImage(from, teks, trans, img, but)
break
case 'pembayaran':
...
zeroyt7.sendMessage(from, slam, MessageType.text, {quoted: finvite})
		...
		if (budy.includes(`@6281215567282`)) {
                  ...
                  replyWithFakeLink(`_Jangan Kasar Lah Suu_`)
